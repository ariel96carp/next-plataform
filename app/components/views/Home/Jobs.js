...
const Jobs = () => (
    <section className="section">
        <div className="page-container">
            <div className="flex flex-col items-center gap-6 md:gap-8 text-center md:w-[80%] lg:w-[60%] mx-auto">
                <h2 className="font-black text-4xl font-title-font">¿Querés trabajar con nosotros?</h2>
                <p className="text-edsoft-gray-light">
                    Es momento de convertir tu idea en algo real. Puedes contactarnos en nuestras
                    redes sociales o enviando un correo a:
                </p>
