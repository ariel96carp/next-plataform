    ...
    <section className="section">
        <div className="page-container">
            ...
            <div className="lg:w-[65%] mx-auto flex flex-col gap-10 sm:gap-14 md:gap-20">
                <AboutCard
                    imageSrc="/images/priscilla-du-preez-VTE4SN2I9s0-unsplash.jpg"
                ...
                />
                <AboutCard
                    imageSrc="/images/danial-igdery-FCHlYvR5gJI-unsplash.jpg"
                    title="Misión"
                ...
                />
                <AboutCard
                    imageSrc="/images/kenny-eliason-1-aA2Fadydc-unsplash.jpg"
                    title="Visión"
